...
CreateToggle("NOCLIP (ANTI-MUR)", 145, "Noclip")
CreateToggle("FLY MODE (F)", 180, "Fly", HandleFly)
CreateToggle("VISIBILITÉ FOV", 215, "ShowFOV")
CreateAdjuster("FOV SIZE", 255, "FOV", 20)
CreateAdjuster("SPEED MULTI", 290, "SpeedPower", 0.2)

local bKill = Instance.new("TextButton", Main)
bKill.Size = UDim2.new(0, 200, 0, 45)
bKill.Position = UDim2.new(0, 10, 0, 340)
